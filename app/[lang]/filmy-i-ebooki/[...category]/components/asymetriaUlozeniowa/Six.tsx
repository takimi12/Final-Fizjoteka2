...
const data = [
	...
	},
	{
		...
		tematy: ["konsekwencje nieleczonej asymetrii", "dlaczego warto wdrożyć działania od razu"],
	},
];
			...
			<div className={`${styles.container} Container`}>
				<div className={styles.textCenter}>
					...
					<h6 className={styles.subtitle}>
						Udostępniam spis treści e-booka. Możesz sprawdzić, czy tematy, które poruszam są dla
						Ciebie ważne.
					</h6>
				</div>
				<div className={styles.wraper}>
					{data.map((item, index) => (
						<div key={index} className={styles.card}>
							...
							<h5 className={styles.title}>{item.tytuł}</h5>

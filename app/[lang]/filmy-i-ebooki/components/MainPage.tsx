				...
				<div className={styles.rightSection}>
					<div className={styles.titleText}>
						{isEnglish ? (
							<>
								...
								<p>
									By gaining unlimited access to videos, you have the opportunity to catch up on
					...
					{isEnglish ? (
						<div className={styles.titleTextEnglish}>
							...
							<p>
								Unfortunately, we do not have any products that meet your criteria. We recommend
								clearing your filters to expand your search.
							</p>
						</div>
					) : (
						<>
